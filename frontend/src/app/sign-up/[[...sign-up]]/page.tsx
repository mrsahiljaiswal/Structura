      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative bg-background">
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="text-center lg:text-left space-y-1">
            <h2 className="text-2xl font-extrabold text-foreground tracking-tight">Create an Account</h2>
            <p className="text-xs text-muted-foreground">Sign up to start generating AI courses from your PDFs</p>
          </div>
