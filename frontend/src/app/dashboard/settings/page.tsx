  ...
  return (
    <DashboardLayout breadcrumbs={breadcrumbs}>
      <div className="space-y-8 max-w-4xl text-left">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                options={[
                  ...
                  { value: "120", label: "120 minutes / day" },
                ]}
                triggerClassName="h-10 w-full md:w-64 rounded-xl border-border bg-card text-xs font-bold"
              />
            </div>
        ...
        <Card className="border border-destructive/30 bg-card shadow-xs">
          <CardHeader className="flex flex-row items-start gap-4 border-b border-destructive/20 pb-4 mb-4">
            <div className="rounded-lg p-2.5 bg-destructive/10 border border-destructive/20 text-destructive">
