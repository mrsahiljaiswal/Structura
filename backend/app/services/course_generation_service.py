...
class CourseGenerationService:
    ...
    def _build_prompt(self, document: ExtractedDocument) -> str:
        ...
        instructions = (
            ...
            "REQUIREMENTS:\n"
            "1. Generate 5 to 8 Chapters structured logically from basic foundation to advanced mastery.\n"
            "2. Each Chapter MUST contain 4 to 6 detailed, dedicated Lessons.\n"
            "3. STRICT CONCEPT SEGREGATION: Divide concepts into distinct, dedicated chapters and lessons. Avoid repeating identical concepts under different chapters.\n"
            "4. RICH SUB-HEADINGS & PARAGRAPHS: Each Lesson's 'explanation' field MUST be a deep markdown prose breakdown (>350 words) featuring multiple relevant subheadings (##, ###), multiple paragraphs, bold terms, and code or math examples where applicable.\n"
